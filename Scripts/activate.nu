...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Sola Agboola\Desktop\Files\Zuri-Training\Django-Models'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Sola Agboola\Desktop\Files\Zuri-Training\Django-Models\Scripts\deactivate.nu'
